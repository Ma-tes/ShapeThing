    ...
    public static class ConnectRoad // TODO Better Name
    {
        public static Shapes GetRoadShape(List<RoadType> roadTypes, List<RECT> neighbors)
        {
            ...
            if (neighbors.Count == 0) 
                return Shapes.Box;
            var Shape = ConnectNeighbors(RectToString(neighbors));
        ...
        public static List<RECT> UpdateRect(List<POINT> roadPositions) 
        {
            ...
            for (int i = 0; i < roadPositions.Count; i++)
            {
                ...
                rectList.Add(ConnectNeighbors(RectToString(GetNeighborsList(roadPositions[i], updatedList))));
            }
            return rectList;
        }
        ...
        private static List<int[]> RectToString(List<RECT> neighbors) 
        {
            if (neighbors.Count == 0)
        ...
        private static string IntoString<T> (this T[] valueArray) 
        {
